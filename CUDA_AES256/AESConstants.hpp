...
namespace aes {
	...
	constexpr uint8_t inverse_sbox[256] = { 0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40,
	...
	constexpr uint8_t mixColumnLookup[3][256] = {
	...
	constexpr uint8_t invMixColumnLookup[4][256] = {
	...
	namespace cuda_con {
		...
		__constant__ uint8_t inverse_sbox[256];
		__constant__ uint8_t invMixColumnLookup[4][256];
		__constant__ uint8_t mixColumnLookup[3][256];
	}
};